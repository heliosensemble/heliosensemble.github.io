...
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Helios Ensemble</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">About Helios</h2>
                    <hr class="light">
                    <p class="text">The Helios Ensemble is a 29-person community vocal performance group based in Tucson, Arizona founded and directed by Benjamen Hansen, //PREFERRED TITLES//. The group strives to cultivate vocal excellence and expressivity and create choral radiance in the Tucson community.</p>
                    <hr class="light">
                </div>
            </div>
        </div>
    ...
    <section id="services">
        ...
        <div class="container">
            <center>
            <iframe width="700" height="450" style="padding:20px;border:0px solid black;" src="https://youtu.be/xtAh3hEBPnk?list=PLikGJSgWcniP73hKmMr2rVWwjM2If14s1" frameborder="0" allowfullscreen></iframe>
            <center>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Festival for Kings and Queens: March 23rd, 2015 </h3>
                        <p class="text-muted">"Music for Kings and Queens" celebrates music for royalty, whether of station, of heart, or of heaven, featuring music from Handel, Purcell, Parry, Howells and more.</p>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Don't know this concert title!</h3>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>A French Delight: July 2014</h3>
                        <p class="text-muted">Need to remember the program.</p>
                        <a href="#about" class="btn btn-primary btn-xl page-scroll">Program</a>
                    </div>
                </div>
            ...
            <div class="row no-gutter">
                <div class="col-lg-4 col-sm-6">
                    <a href="#" class="portfolio-box">
                        <img src="DSC_1119e.jpg" class="img-responsive" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="#" class="portfolio-box">
                        <img src="DSC_1140e.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Concert Name
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="#" class="portfolio-box">
                        <img src="DSC_1232e.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Concert Name
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <hr>
                <p> Donate now through Stripe or contact ___ </p>
            </div>
        </div>
    </aside>
