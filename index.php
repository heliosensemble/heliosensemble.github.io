        ...
        <div class="container" style="opacity:1.0">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <p class="text" style="text-align:justify">The Helios Ensemble is a 40-person community vocal performance group based in Tucson, Arizona founded and directed by Benjamin Hansen. The group creates heartfelt, professional level performances through creative and uplifting group vocal technique. </p>
    ...
    <hr style="margin-top:50px">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3> A Royal Festival</h3>
                        <h4>March 23rd, 2015 </h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-justify">
                    <div class="service-box">
                        <p class="text-muted"> A delightful mix of vocal, organ, and choral works by Poulenc, Saint-Saens, and more.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <a href="#" class="portfolio-box">
                        ...
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                ...
                                <div class="project-name">
                                    Artistic Director Ben Hansen directs the ensemble.
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#" class="portfolio-box">
                        ...
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                ...
                                <div class="project-name">
                                    The Helios Ensemble performs "Funeral Music for Queen Mary" by Purcell.
                                </div>
                            </div>
                        </div>
                    </a>
